...
const netOption = reactive<EChartsOption>(netTrendingOption)
                ...
                <div class="am-column-content">
                    <div class="am-chart-container">
                        <div class="am-chart-container__chart-item">
                            <div class="am-chart-container__chart-info">
                                {{ t('monitor.percent') }}: {{ cpuPercent }}
                            </div>
                            <echarts :option="cpuOption" />
                        </div>
                        <div class="am-chart-container__chart-item">
                            <div class="am-chart-container__chart-info">
                                {{ t('monitor.total') }}:{{ memInfo.total }}
                                {{ t('monitor.used') }}:{{ memInfo.used }}
                                {{ t('monitor.percent') }}: {{ memInfo.percent }}
                            </div>
                            <echarts :option="memOption" />
                        </div>
                        <div class="am-chart-container__chart-item">
                            <div class="am-chart-container__chart-info" v-for="(item, index) in diskInfo" :key="index">
                                {{ item.device }}
                                {{ t('monitor.total') }}:{{ item.total }}
                                {{ t('monitor.used') }}:{{ item.used }}
                                {{ t('monitor.percent') }}:{{ item.percent }}
                            </div>
                            <echarts :option="diskOption" />
                        </div>
                        <div class="am-chart-container__chart-item">
                            <div class="am-chart-container__chart-info" v-for="(item, index) in netInfo" :key="index">
                                {{ item.ethernet }}
                                {{ t('monitor.receive') }}:{{ item.read }}
                                {{ t('monitor.send') }}:{{ item.write }}
                            </div>
