...
<template>
    <el-drawer v-model="drawerVisible" :title="t(props.title as string)" size="50%">
        <div class="am-network-create__content">
            <el-form ref="networkCreateRef" :model="networkCreateMode" :rules="rules" label-width="160px"
                label-position="left">
                ...
                <el-form-item :label="t('network.networkMode')" prop="networkMode">
                    <el-select v-model="networkCreateMode.networkMode" style="width: 240px"
                        :placeholder="t('network.networkModePlaceholder')">
                ...
                <el-form-item :label="t('network.networkTag')" prop="networkLabels">
                    <el-input v-model="networkCreateMode.networkLabels" type="textarea" :rows="4"
                        :placeholder="t('network.networkLabelPlaceholder')" />
                </el-form-item>
            </el-form>
        </div>
        <div class="am-network-create__operator">
            ...
            <el-button v-loading="createNetworkLoading" type="primary" size="default" plain
