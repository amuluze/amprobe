...
type IContainerService interface {
	...
	ContainerCreate(context.Context, schema.ContainerCreateArgs) error
	ContainerUpdate(context.Context, schema.ContainerUpdateArgs) error
	ContainerDelete(context.Context, schema.ContainerDeleteArgs) error
	ContainerStart(context.Context, schema.ContainerStartArgs) error
	ContainerStop(context.Context, schema.ContainerStopArgs) error
	ContainerRestart(context.Context, schema.ContainerRestartArgs) error

	ImageList(ctx context.Context, args schema.ImageQueryArgs) (schema.ImageQueryReply, error)
	ImagePull(context.Context, schema.ImagePullArgs) error
	ImageTag(context.Context, schema.ImageTagArgs) error
	ImageDelete(context.Context, schema.ImageDeleteArgs) error
	ImagesPrune(ctx context.Context) error
	ImageImport(context.Context, schema.ImageImportArgs) error
	ImageExport(context.Context, schema.ImageExportArgs) error

	NetworkList(ctx context.Context, args schema.NetworkListArgs) (schema.NetworkListReply, error)
	NetworkCreate(context.Context, schema.NetworkCreateArgs) error
	NetworkDelete(context.Context, schema.NetworkDeleteArgs) error
...
func (a *ContainerService) ContainerCreate(ctx context.Context, args schema.ContainerCreateArgs) error {
...
func (a *ContainerService) NetworkCreate(ctx context.Context, args schema.NetworkCreateArgs) error {
