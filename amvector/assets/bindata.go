...
var _bindata = map[string]func() ([]byte, error){
	...
	"assets/resources/amprobe/configs/init.yaml": assets_resources_amprobe_configs_init_yaml,
		...
		"resources": &_bintree_t{nil, map[string]*_bintree_t{
			"amprobe": &_bintree_t{nil, map[string]*_bintree_t{
				"configs": &_bintree_t{nil, map[string]*_bintree_t{
					...
					"init.yaml": &_bintree_t{assets_resources_amprobe_configs_init_yaml, map[string]*_bintree_t{
					}},
				}},
